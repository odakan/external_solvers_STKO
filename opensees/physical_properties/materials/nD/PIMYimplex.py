...
def writeTcl(pinfo):
    ...
    #nDmaterial PIMYimplex $tag -rho $rho -Gref $refShearModul -Kref $refBulkModul -cohesion $cohesion
	# -gPeak $peakShearStra -fAngle $frictionAng=0. -Pref $refPress=100. -mPow $pressDependCoe=0. -tnys $noYieldSurf=20 <$r1 $Gs1>
	...
	str_tcl = '{}nDMaterial PIMYImplex {} -rho {} -Gref {} -Kref {} -cohesion {} -gPeak {} -fAngle {} -Pref {} -mPow {} -tnys {}\\\n\t{}\n'.format(
			pinfo.indent, tag, rho.value, refShearModul.value, refBulkModul.value, cohesi.value, peakShearStra, frictionAng, refPress.value, pressDependCoe, surf, opt)
